...
from event_management_system.settings.installed_apps import INSTALLED_APPS
...
SHELL_PLUS_IMPORTS = [
    ...
    "from event_management_system.core import exceptions, typing",
    "from event_management_system.core import models, views, serializers, factories",
]
